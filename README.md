...
This project provides an example of using Cloudera Manager's Python API Client to create a Flume-NG Service and Agents, to set and update Flume-NG Agent config files, and to restart Flume-NG Agent processes.
